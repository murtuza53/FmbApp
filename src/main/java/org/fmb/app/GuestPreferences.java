...
public class GuestPreferences implements Serializable {
    ...
    private String layoutPrimaryColor = "yellow";

    private String componentTheme = "yellow";
    
    private String menuTheme = "yellow";
    
    private String menuColor = "dark"; //light custom     //for menu mode
    
    private String selectedMenuColor;

    private boolean horizontalMenu;
    
    private boolean darkMode;                       //for components
    ...
    public void setLayout(String color){
        this.setLayoutPrimaryColor(color);
    }
